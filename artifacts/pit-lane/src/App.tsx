        ...
        <main className="flex-1 max-w-[680px] w-full mx-auto p-4">
          <div className="flex flex-col gap-2 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <button
              ...
              className="group relative overflow-hidden rounded-xl p-4 text-left transition-all active:scale-[0.98] bg-gradient-to-br from-[#1a0a0a] to-[#111] border border-[#2a1a1a] border-l-[3p[...]"
            >
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <div className="text-[11px] text-[#666] leading-snug">Preview quiz, post-race review, and general F1 trivia — all in one place</div>
              </button>
