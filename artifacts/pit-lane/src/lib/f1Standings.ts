...
export const DEFAULT_STANDINGS: StandingsData = {
  ...
  drivers: [
    ...
    { pos: 17, code: "HUL", name: "Nico Hülkenberg",    team: "Audi",            teamColor: "#9B9B9B", country: "DE", points: 0, wins: 0, podiums: 0 },
    { pos: 18, code: "BOR", name: "Gabriel Bortoleto",  team: "Audi",            teamColor: "#9B9B9B", country: "BR", points: 0, wins: 0, podiums: 0 },
  ...
  constructors: [
    ...
    { pos: 9,  name: "Audi",            color: "#9B9B9B", points: 0, wins: 0 },
