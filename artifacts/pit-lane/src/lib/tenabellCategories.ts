...
export const CATEGORIES: Category[] = [
  ...
  {
    q: "Name the top 10 drivers with the most career race wins in Formula 1 history",
    teaser: "Most career race wins",
    answers: [
      { name: "Hamilton" },
      { name: "Schumacher" },
      { name: "Verstappen" },
    ...
    hint: "Lewis Hamilton holds the all-time record with over 100 career wins",
    ordered: false,
  },
  {
  ...
  {
    q: "Name the top 10 drivers with the most wins at the Italian Grand Prix at Monza",
  ...
  },
  {
    ...
    hint: "British drivers have won more championships than any other nation — over 20 combined titles",
    ordered: false,
    kind: "countries",
  },
  {
  ...
  },
  {
    ...
    hint: "Max Verstappen was 17 years and 166 days old when he scored his first point at the 2015 Malaysian GP",
    ordered: false,
  },
  {
  ...
  },
  {
    ...
    hint: "Lance Stroll took his first and only career pole position in the wet — but Hamilton sealed his 7th title with the win",
    ordered: false,
  },
  {
